...
## What we run, and why it lives only on this computer

The same smaller classifier sits behind a local web service and a model catalog.
**Nothing is hosted on the public internet. When this computer is off, the classify
page and the catalog are down.**
...
prod/               Local classify service, model catalog, daily pull / mix job
...
- Daily pull, score, and mix check: `python -m prod.loop`
